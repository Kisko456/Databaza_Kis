        ...
        <div class="row">
            <div class="panel panel-default">
                <div class="panel-heading">Detail cesty <a href="<?php
                    echo site_url('kategorie/'); ?>" class="glyphicon glyphicon-arrow-left
pull-right"></a></div>
                <div class="panel-body">
                    <div class="form-group">
                        <label>Kategória:</label>
                        <p><?php echo
                            !empty($kategorie['Kategoria'])?$kategorie['Kategoria']
                                :''; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Číslo cesty:</label>
                        <p><?php echo
                            !empty($kategorie['Cislo_cesty'])?$kategorie['Cislo_cesty']:'';
                            ?></p>
                    </div>
                    <div class="form-group">
                        <label>Dĺžka cesty v KM:</label>
                        <p><?php echo
                            !empty($kategorie['Dlzka_cesty'])?$kategorie['Dlzka_cesty']:''; ?></p>
                    </div>

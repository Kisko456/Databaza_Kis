...
<div class="container">
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading">Detail oblasti <a href="<?php
                echo site_url('oblast/'); ?>" class="glyphicon glyphicon-arrow-left
pull-right"></a></div>
            <div class="panel-body">
                <div class="form-group">
                    <label>Štát:</label>
                    <p><?php echo
                        !empty($oblast['Stat'])?$oblast['Stat']
                            :''; ?></p>
                </div>
                <div class="form-group">
                    <label>Kraj:</label>
                    <p><?php echo
                        !empty($oblast['Kraj'])?$oblast['Kraj']:'';
                        ?></p>
                </div>
                <div class="form-group">
                    <label>Okres:</label>
                    <p><?php echo
                        !empty($oblast['Okres'])?$oblast['Okres']:''; ?></p>
                </div>
                <div class="form-group">
                    <label>Mesto:</label>
                    <p><?php echo
                        !empty($oblast['Mesto'])?$oblast['Mesto']:''; ?></p>
                </div>
